...
class Join {
  ...
  parse(doc) {
    ...
    if (doc.sourceColumns)
      this.sourceColumns = doc.sourceColumns;
    if (doc.targetColumns)
      this.targetColumns = doc.targetColumns;
    // this.sourceColumns = parseList(doc.sourceColumns || doc.sourceColumn || this.sourceColumns);
    // this.targetColumns = parseList(doc.targetColumns || doc.targetColumn || this.targetColumns);
  }
